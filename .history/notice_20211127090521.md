...
- \_\_clone() : Khi quá trình nhân bản hoàn tất, nếu phương thức **clone () được xác định, thì phương thức **clone () của đối tượng mới được tạo sẽ được gọi, để cho phép bất kỳ thuộc tính cần thiết nào cần được thay đổi.
